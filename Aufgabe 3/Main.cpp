...
public:
	D1(int C1_a = 0xD1C1A, int C2_a = 0xD1C2A, int C1_b = 0xD1C1B, int C2_b = 0xD1C2B)
		: C1(C1_a, C1_b), C2(C2_a, C2_b) {}

	// Der Wert für C1::a C2::a = D1A wird nicht ausgegeben warum???
	// Wert D1A git es nicht. Fehler ???
	void print() {
		cout << "D1::print() ..." << endl;
...
public:
	D2(int C1_a = 0xD2C1A, int C2_a = 0xD2C2A, int C3_a = 0xD2C3A, int C1_b = 0xD2C1B, int C2_b = 0xD2C2B, int C3_b = 0xD2C3B)
		: C1(C1_a, C1_b), C2(C2_a, C2_b), C3(C3_a, C3_b) {}

	// Der Wert für C1::b C2::b = D2B wird nicht ausgegeben warum???
	// Wert D2B git es nicht. Fehler ???
	void print() {
		cout << "D2::print() ..." << endl;
